...
if ($cowboyHatLayer -notmatch '(?s)getChild\("head_parts"\)\.translateAndRotate\(pose\).*?translate\(0,-\.4F-1F/16F,3F/32F\).*?rotationDegrees\(-25\)') {
    Add-Failure 'Leader-horse Cowboy Hat must retain its skull-centered Z anchor and one-pixel upward seating correction'
}
