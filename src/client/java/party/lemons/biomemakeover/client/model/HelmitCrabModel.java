...
import party.lemons.biomemakeover.client.render.HelmitCrabRenderState;
import net.minecraft.util.Mth;

public class HelmitCrabModel extends EntityModel<HelmitCrabRenderState> implements HeadedModel
{
	...
	@Override
	public void setupAnim(HelmitCrabRenderState state)
	{
		...
		if(!state.hiding)
		{
			...
			float swing = Mth.cos(limbAngle) * limbDistance * 0.4F;
			claw_left.zRot = swing;
			claw_right.zRot = -swing;
		}
		else
		{
			head.visible = false;
