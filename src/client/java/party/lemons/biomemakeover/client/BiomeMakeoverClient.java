...
import party.lemons.biomemakeover.client.render.HelmitCrabRenderer;
...
public final class BiomeMakeoverClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRenderers.register(BMEntities.HELMIT_CRAB, HelmitCrabRenderer::new);
        EntityRenderers.register(BMEntities.ANCIENT_OAK_BOAT, context -> new BoatRenderer(context, BMModelLayers.ANCIENT_OAK_BOAT));
        EntityRenderers.register(BMEntities.ANCIENT_OAK_CHEST_BOAT, context -> new BoatRenderer(context, BMModelLayers.ANCIENT_OAK_CHEST_BOAT));
        EntityRenderers.register(BMEntities.WILLOW_BOAT, context -> new BoatRenderer(context, BMModelLayers.WILLOW_BOAT));
        EntityRenderers.register(BMEntities.WILLOW_CHEST_BOAT, context -> new BoatRenderer(context, BMModelLayers.WILLOW_CHEST_BOAT));
        EntityRenderers.register(BMEntities.SWAMP_CYPRESS_BOAT, context -> new BoatRenderer(context, BMModelLayers.SWAMP_CYPRESS_BOAT));
        EntityRenderers.register(BMEntities.SWAMP_CYPRESS_CHEST_BOAT, context -> new BoatRenderer(context, BMModelLayers.SWAMP_CYPRESS_CHEST_BOAT));
        EntityRenderers.register(BMEntities.BLIGHTED_BALSA_BOAT, context -> new BoatRenderer(context, BMModelLayers.BLIGHTED_BALSA_BOAT));
        EntityRenderers.register(BMEntities.BLIGHTED_BALSA_CHEST_BOAT, context -> new BoatRenderer(context, BMModelLayers.BLIGHTED_BALSA_CHEST_BOAT));
