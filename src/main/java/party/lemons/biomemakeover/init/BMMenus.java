...
public final class BMMenus {
    ...
    private static final ResourceKey<MenuType<?>> WITCH_KEY = ResourceKey.create(Registries.MENU, BiomeMakeover.id("witch"));
    public static final MenuType<WitchMenu> WITCH = Registry.register(BuiltInRegistries.MENU, WITCH_KEY,
        new MenuType<>(WitchMenu::new, FeatureFlags.VANILLA_SET));
