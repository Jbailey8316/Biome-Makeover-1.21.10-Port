...
| Cowboy/horse patrols and hats | Cowboy, exact equipment/drop chances, mounted Badlands patrol injection, custom leader banner, synchronized/persistent horse state, Cowboy/leader-horse hat layers, despawn and scoped Bad/Raid Omen translation | COMPATIBLE / NEEDS-RUNTIME-VERIFICATION | Released lifecycle is statically restored; direct summon, natural patrol, rendering, drops, persistence/despawn and progression require focused Prism verification |
